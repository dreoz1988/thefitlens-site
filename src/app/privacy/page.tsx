        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section id="s2">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>AI coaching prescriptions: structured recommendations in the areas of nutrition, activity, and sleep and recovery, generated by our AI coaching system, which may incorporate joint or physical limitation information you have provided alongside your logged activity</li>
            ...
            <div className="overflow-x-auto mt-4">
              <table className="w-full text-sm border border-neutral-300 border-collapse">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        ...
                        <li>Generate AI coaching and prescriptions</li>
                  ...
                  <tr>
                    ...
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        ...
                        <li>Generate AI coaching prescriptions</li>
                  ...
                  <tr>
                    ...
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        ...
                        <li>Generate AI nutrition coaching prescriptions</li>
                        <li>Service improvement and analytics</li>
                      </ul>
                    </td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                  ...
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Inferences (Composite Body Score, coach prescriptions, health risk flags, progress projections)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
          ...
          <section id="s17">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>AI/ML service providers who process data to generate coaching prescriptions and AI Chef features, subject to Data Processing Agreements prohibiting use for their own purposes</li>
