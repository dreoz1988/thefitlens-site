      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section id="s2">
            ...
            <p>We collect personal data, including sensitive health information, in the following ways:</p>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Manual workout entries (activity type, duration, and optional effort or calorie estimates)</li>
              <li>GLP-1 medication and dosage information (if you use the GLP-1 tracking features)</li>
              <li>Self-reported GLP-1 side effect logs (symptom type, severity, date, and optional notes)</li>
              <li>Joint, injury, or physical limitation information you provide during onboarding or in your profile</li>
            ...
            <p className="mt-3">We receive this data directly from your device over Bluetooth. We do not control the device manufacturer&rsquo;s own data collection practices. Please review the privacy policy of your scale or device manufacturer separately.</p>
            ...
            <p className="mt-3">You control which Health Connect data types the Services may access through your Android device&rsquo;s Health Connect settings. You may revoke permissions at any time.</p>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li>Composite Body Score: a proprietary weighted score calculated from your body composition measurements, activity, nutrition, and sleep data</li>
              <li>AI coaching recommendations: structured recommendations in the areas of nutrition, activity, and sleep and recovery, generated by our AI coaching system, which may incorporate joint or physical limitation information you have provided alongside your logged activity</li>
              <li>Clinical threshold alerts: automated flags when your data crosses clinically referenced thresholds (e.g., body fat percentage, blood pressure, SpO2) that may warrant attention</li>
              <li>Health summary PDF: a shareable document summarizing your health data trends, intended for optional sharing with a healthcare provider</li>
            </ul>
          ...
          <section id="s3">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Generate your Composite Body Score, coaching recommendations, clinical threshold alerts, and health summary PDF</li>
            ...
            <p className="mt-3">We do not use your health or body composition data to serve you targeted advertising. We do not sell your personal data to third parties for monetary compensation.</p>
          </section>
          ...
          <section id="s4">
            ...
            <p>We use third-party service providers to operate the Services. These providers access personal data only to perform services on our behalf and are contractually prohibited from using your data for their own purposes, under Data Processing Agreements that require them to protect your data consistent with this Policy. These include:</p>
            <ul className="list-disc pl-6 space-y-2 mt-3">
          ...
          <section id="s7">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li>The FTC Health Breach Notification Rule (16 C.F.R. Part 318, as amended effective July 29, 2024), which requires notification to affected individuals and the FTC within 60 calendar days of discovery of a breach affecting 500 or more individuals. For breaches affecting fewer than 500 individuals, we will notify affected individuals within 60 days of discovery. The Fit Lens almost certainly qualifies as a &lsquo;vendor of personal health records&rsquo; or &lsquo;PHR-related entity&rsquo; under the amended HBNR given that it draws health data from multiple sources (user input, BLE scales, and Android Health Connect).</li>
              <li>Arizona Data Breach Notification Law (A.R.S. § 18-552), which requires notification to affected Arizona residents in the most expedient manner possible and without unreasonable delay following discovery of a breach involving personal information.</li>
          ...
          <section id="s8">
            ...
            <p>The Services integrate with third-party platforms and devices. When you connect a third-party service or device to the Services, you are subject to that third party&rsquo;s privacy policy and terms of service in addition to this Policy. We are not responsible for the privacy practices of third parties. Third-party integrations currently supported or planned include:</p>
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li>Android Health Connect (Google): governs access to health data stored on your device</li>
              <li>Bluetooth smart scales (Renpho, Etekcity, Welland, and others), governed by respective manufacturer privacy policies</li>
              <li>Samsung Galaxy Watch / Samsung Health: governed by Samsung&rsquo;s privacy policy</li>
              <li>Open Food Facts: open-source food database; no personal data is transmitted to Open Food Facts</li>
            </ul>
          </section>
          ...
          <section id="s9">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li>Coach recommendations (nutrition, activity, sleep and recovery recommendations tailored to your data)</li>
              ...
              <li>GLP-1 side effect education content: general informational summaries drawn from published clinical trial literature</li>
            </ul>
            <p className="mt-3">These AI features process your personal data, including health and body composition data, to generate personalized recommendations. We use third-party AI/ML service providers to power certain features. These providers are contractually bound to use your data only to deliver the services to us and are not permitted to use your data for their own AI training without your consent.</p>
            <p className="mt-3">AI-generated coaching recommendations and health summaries are informational only and do not constitute medical advice. Always consult a qualified healthcare professional before making changes to your health, nutrition, or fitness regimen. GLP-1 side effect education content is general informational material and is not personalized to you; it does not diagnose any condition, suggest medication dosing changes, or compare the relative merits of different medications.</p>
          </section>
          ...
          <section id="s11">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li>Right to Know: request disclosure of the categories and specific pieces of personal information we have collected, used, disclosed, or sold</li>
              <li>Right to Delete: request deletion of personal information we have collected, subject to exceptions</li>
              <li>Right to Correct: request correction of inaccurate personal information</li>
              <li>Right to Opt-Out of Sale or Sharing: we do not sell personal data or share it for cross-contextual behavioral advertising</li>
              ...
              <table className="w-full text-sm border border-neutral-300 border-collapse">
                <thead>
                  <tr className="bg-neutral-100">
                    <th className="border border-neutral-300 px-3 py-2 text-left align-top">Category of Personal Data</th>
                    <th className="border border-neutral-300 px-3 py-2 text-left align-top">Purposes for Collection</th>
                    <th className="border border-neutral-300 px-3 py-2 text-left align-top">Third Parties Disclosed To / Sold or Shared</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Registration &amp; Account Data (name, email, password, date of birth, sex, height, starting weight, goal weight)</td>
                    ...
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Disclosed To:</li>
                        <li>Technology/hosting providers (Supabase)</li>
                  ...
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Body Composition &amp; Biometric Data (weight, body fat %, lean mass, muscle mass, BMI, segmental measurements, Composite Body Score, trend data)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Provide core body composition tracking</li>
                        <li>Generate AI coaching and recommendations</li>
                        <li>Generate health summaries (PDF)</li>
                        <li>Service improvement and analytics</li>
                        <li>With your consent: share with healthcare providers</li>
                      </ul>
                    </td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        ...
                        <li>AI/ML service providers (for coaching features)</li>
                        <li>Healthcare providers (only upon your explicit request)</li>
                      </ul>
                      <p className="mt-2 font-medium">Not Sold or Shared for Targeted Advertising</p>
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Health Connect &amp; Wearable Data (steps, active calories, HRV, SpO2, respiratory rate, blood pressure, VO2 max, body fat from wearable, lean body mass from wearable, sleep data)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Provide activity and recovery tracking</li>
                        <li>Generate AI coaching recommendations</li>
                        <li>Populate GLP-1 dashboard and health summaries</li>
                  ...
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Nutrition &amp; Food Log Data (meals logged, food items, macros, calorie targets, AI Chef interactions, meal plan data)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Provide food logging and nutrition tracking</li>
                        <li>Generate AI nutrition coaching recommendations</li>
                        <li>Service improvement and analytics</li>
                      </ul>
                    </td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Disclosed To:</li>
                        <li>Hosting/infrastructure providers</li>
                        <li>AI/ML service providers (for AI Chef and coaching)</li>
                      </ul>
                      <p className="mt-2 font-medium">Not Sold or Shared for Targeted Advertising</p>
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">GLP-1 Medication &amp; Side Effect Data (medication, dosage, self-reported side effects, severity, notes)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Provide GLP-1 tracking features</li>
                        <li>Generate GLP-1 coaching content and side effect education</li>
                        <li>Populate Share with Doctor summary (upon your request)</li>
                        <li>Service improvement</li>
                      </ul>
                    </td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                  ...
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Joint/Injury &amp; Physical Limitation Data (self-reported limitations provided during onboarding or profile setup)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Personalize AI coaching recommendations</li>
                        <li>Service improvement</li>
                      </ul>
                    </td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                  ...
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Manual Workout Data (activity type, duration, optional effort or calorie estimates)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Provide activity tracking</li>
                        <li>Generate AI coaching recommendations</li>
                        <li>Service improvement</li>
                      </ul>
                    </td>
                  ...
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Device &amp; Technical Data (device model, OS version, app version, device ID, IP address, crash diagnostics)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Ensure technical functionality</li>
                        <li>Debug, troubleshoot, and prevent fraud</li>
                        <li>Security and integrity of systems</li>
                        <li>Analytics</li>
                      </ul>
                    </td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Disclosed To:</li>
                        <li>Hosting/infrastructure providers</li>
                        <li>Crash analytics providers</li>
                  ...
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Usage &amp; Interaction Data (features accessed, screens visited, timestamps, in-app behavior, logging frequency)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                  ...
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Inferences (Composite Body Score, coach recommendations, health risk flags, progress projections)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Personalize coaching and recommendations</li>
                        <li>Generate clinical threshold alerts</li>
                        <li>Generate health summaries</li>
                        <li>Service improvement</li>
                      </ul>
                    </td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Disclosed To:</li>
                        <li>Hosting/infrastructure providers</li>
                        <li>AI/ML providers (input data, not final inferences)</li>
                        <li>Healthcare providers (only upon your explicit request)</li>
                      </ul>
                      <p className="mt-2 font-medium">Not Sold or Shared for Targeted Advertising</p>
                    </td>
                  ...
                  <tr>
                    <td className="border border-neutral-300 px-3 py-2 align-top font-medium">Payment Data (subscription status, transaction history; payment card details processed by third-party payment processor)</td>
                    <td className="border border-neutral-300 px-3 py-2 align-top">
                      <ul className="list-disc pl-4 space-y-1">
          ...
          <section id="s17">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Self-reported GLP-1 medication, dosage, and side effect information</li>
              <li>Self-reported joint, injury, or physical limitation information</li>
              <li>Information derived or inferred from the above data, including your Composite Body Score, AI coaching recommendations, and clinical threshold alert history</li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Generate your Composite Body Score, coaching recommendations, clinical threshold alerts, and health summaries</li>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>AI/ML service providers who process data to generate coaching recommendations and AI Chef features, subject to Data Processing Agreements prohibiting use for their own purposes</li>
              <li>Healthcare providers: only upon your explicit, user-initiated request via the Share with Doctor feature</li>
          ...
          <section id="s18">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Self-reported GLP-1 medication, dosage, and side effect information, and joint/injury or physical limitation information</li>
              <li>Data derived or inferred from the above, including your Composite Body Score and AI coaching recommendations</li>
            </ul>
            <h3 className="text-lg font-semibold mt-4 mb-2">Purposes for Collecting Consumer Health Data</h3>
