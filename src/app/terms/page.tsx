      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section id="s1">
            ...
            <p className="mt-3">These Terms of Service (&quot;Terms&quot;) constitute a legally binding agreement between you and The Fit Lens LLC (&quot;The Fit Lens,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), an Arizona Domestic Limited Liability Company (ACC Business ID: 25083180), governing your access to and use of the The Fit Lens mobile application, website, and all related features and services (collectively, the &quot;Services&quot;). Please read these Terms carefully. By creating an account, selecting &quot;I Agree,&quot; or by otherwise accessing or using the Services in any manner, you: (a) acknowledge that you have read, understood, and agree to be bound by these Terms; (b) agree to our Privacy Policy, available at thefitlens.com/privacy, which is incorporated herein by reference; (c) represent and warrant that you are at least 18 years of age and have the legal capacity to enter into a binding agreement; and (d) acknowledge that where applicable law requires your separate, affirmative consent to the collection or sharing of consumer health data, including under the Washington My Health My Data Act and the Nevada Consumer Health Data Privacy Act, that consent is obtained through a distinct consent step within the Services, as described in Sections 17 and 18 of the Privacy Policy, and is not satisfied merely by your acceptance of these Terms. If you do not agree to these Terms in their entirety, you must not access or use the Services.</p>
            <h3 className="text-lg font-semibold mt-4 mb-2">Not Medical Advice</h3>
            <p>By providing the Services, The Fit Lens LLC does not practice medicine, provide healthcare, or render any form of medical advice. The Fit Lens does not diagnose, treat, cure, mitigate, or prevent any disease, disorder, or health condition. The body composition tracking, nutrition logging, AI coaching recommendations, Composite Body Score, clinical threshold alerts, health summary PDF, GLP-1 dashboard, and all other features, outputs, and insights provided through the Services are intended solely to support your personal health and wellness awareness, education, and self-management goals. They do not replace, and must not be used as a substitute for, professional medical advice, diagnosis, or treatment from a qualified and licensed healthcare provider.</p>
          ...
          <section id="s7">
            ...
            <p>The Services use artificial intelligence and machine learning technology to generate personalized coaching recommendations, scores, alerts, and meal suggestions. You acknowledge and agree that:</p>
            <ul className="list-disc pl-6 space-y-2 mt-3">
            ...
            <p>Before any health summary PDF is generated or shared, the Services will show you a preview of the specific data to be included and allow you to review, edit, or remove any entry, including self-reported logs such as GLP-1 side effects, prior to generation or sharing. If you use the health summary PDF feature to share data with a healthcare provider, you acknowledge that: (a) the summary contains data you have self-reported and data received from consumer-grade tracking devices, as reviewed and confirmed by you prior to sharing; (b) the accuracy of the data depends on the accuracy of your inputs and the reliability of your connected devices; (c) the summary is provided for informational reference only and does not meet the standards of a clinical report; and (d) your healthcare provider may not act on, agree with, or endorse the data in the summary, which is their professional prerogative.</p>
          ...
          <section id="s8">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Coach-v2 AI Recommendation System: the artificial intelligence and machine learning system used to generate structured coaching recommendations in the domains of Nutrition, Activity, and Sleep and Recovery</li>
          ...
          <section id="s13">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Clinical threshold alerts and coaching recommendation notifications, when enabled in your account settings</li>
            ...
            <p>All AI-generated outputs delivered through the Services, including coaching recommendations, meal suggestions, Composite Body Score interpretations, and clinical threshold alerts, are subject to the following limitations and acknowledgments:</p>
            <ul className="list-disc pl-6 space-y-2 mt-3">
          ...
          <section id="s16">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Annual subscription: $79.99 per year, billed in a single upfront payment</li>
            </ul>
          ...
          <section id="s17">
            ...
            <p>THE SERVICES, INCLUDING ALL FEATURES, CONTENT, AI-GENERATED OUTPUTS, COACHING RECOMMENDATIONS, THE COMPOSITE BODY SCORE, CLINICAL THRESHOLD ALERTS, HEALTH SUMMARY PDF, GLP-1 DASHBOARD, AI CHEF OUTPUTS, AND ALL OTHER INFORMATION AND MATERIALS MADE AVAILABLE THROUGH THE SERVICES, ARE PROVIDED ON AN &quot;AS IS&quot; AND &quot;AS AVAILABLE&quot; BASIS WITHOUT ANY WARRANTY OF ANY KIND, EXPRESS OR IMPLIED.</p>
            ...
            <p className="mt-3">AI AND MACHINE LEARNING OUTPUTS GENERATED BY THE SERVICES, INCLUDING COACHING RECOMMENDATIONS, COMPOSITE BODY SCORE CALCULATIONS, CLINICAL THRESHOLD ALERTS, AND MEAL SUGGESTIONS, ARE SUBJECT TO THE INHERENT LIMITATIONS OF AI TECHNOLOGY, INCLUDING THE POTENTIAL FOR ERRORS, INCOMPLETE OUTPUTS, BIAS, AND FACTUALLY INCORRECT INFORMATION COMMONLY REFERRED TO AS &quot;HALLUCINATIONS.&quot; ALL RELIANCE ON AI-GENERATED OUTPUTS IS AT YOUR SOLE RISK.</p>
          ...
          <section id="s18">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>Your use or misuse of the Services, including your reliance on any AI-generated output, alert, recommendation, or score</li>
          ...
          <section id="s19">
            ...
            <p>TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL THE FIT LENS LLC, ITS AFFILIATES, LICENSORS, SERVICE PROVIDERS, EMPLOYEES, AGENTS, OFFICERS, OR DIRECTORS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES OF ANY KIND, ARISING OUT OF OR IN CONNECTION WITH: (A) YOUR USE OF, OR INABILITY TO USE, THE SERVICES; (B) ANY AI-GENERATED OUTPUT, COACHING RECOMMENDATION, ALERT, OR SCORE PROVIDED THROUGH THE SERVICES; (C) ANY ACTION OR INACTION YOU TAKE BASED ON INFORMATION RECEIVED FROM THE SERVICES; (D) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SERVERS OR ANY PERSONAL DATA STORED THEREIN; (E) ANY INTERRUPTION OR CESSATION OF THE SERVICES; OR (F) ANY CONTENT OR CONDUCT OF ANY THIRD PARTY IN CONNECTION WITH THE SERVICES.</p>
